...
__all__ = [ "recursive_dynamic", "iterative", "power_matrix", "iterative_asm", "recursive_dynamic_O3", "iterative_O3", "iterative_asm_03", "power_matrix_O3", "algos"]
...
iterative_asm_O3 = imp.iterative_asm_O3
...
algos = {'recursive_dynamic': recursive_dynamic,
         ...
         'iterative_asm_O3': iterative_asm_O3,
